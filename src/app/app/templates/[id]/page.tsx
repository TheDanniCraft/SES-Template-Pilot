...
export default async function TemplateEditorPage({
    ...
    return (
      <section className="space-y-4">
        ...
        <div className="panel rounded-xl p-4">
          <TemplateEditorForm
            key={`draft:${localById.id}:${String(localById.updatedAt ?? localById.createdAt ?? "")}`}
            brandKits={brandKits}
            initialValues={{
              id: localById.id,
              name: localById.name,
              ...
              editorJson: localById.editorJson ?? undefined,
  ...
  if (localBySesName) {
    return (
      <section className="space-y-4">
        ...
        <div className="panel rounded-xl p-4">
          <TemplateEditorForm
            key={`draft:${localBySesName.id}:${String(localBySesName.updatedAt ?? localBySesName.createdAt ?? "")}`}
            brandKits={brandKits}
            initialValues={{
              ...
              editorJson: localBySesName.editorJson ?? undefined,
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="panel rounded-xl p-4">
        <TemplateEditorForm
          key={`ses:${sesTemplate.data.TemplateName ?? id}`}
          brandKits={brandKits}
          initialValues={{
